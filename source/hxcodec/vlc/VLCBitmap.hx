...
class VLCBitmap extends Bitmap
{
	...
	// Playback Methods
	public function play(?location:String = null, loop:Bool = false,startPaused = false):Void
	{
	...
	public function resume():Void
	{
		...
		{
			paused = false;
			time = Std.int(Conductor.songPosition - startPos);
	...
	private function onEnterFrame(e:Event):Void
	{
		...
		if ((isPlaying && isDisplaying) && (videoWidth > 0 && videoHeight > 0) && pixels != null && !paused)
		{
