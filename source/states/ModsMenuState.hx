...
class ModsMenuState extends MusicBeatState {
	...
	function updateModDisplayData() {
		...
		colorTween = FlxTween.color(bg, 1, bg.color, curMod.bgColor, {
...
class ModItem extends FlxSpriteGroup {
	...
	public function new(folder:String) {
		...
		if (pack != null) {
			...
			if (pack.color != null) {
				this.bgColor = FlxColor.fromRGB(pack.color[0] != null ? pack.color[0] : 170, pack.color[1] != null ? pack.color[1] : 0, pack.color[2] != null ? pack.color[2] : 255);
			}
